...
class MiniImageNet_DatasetLoader(Dataset):

    def __init__(self, args, setname, train_augmentation=None):
        IMAGE_PATH = os.path.join(args.data_path, f'mini-imagenet/images/{setname}')
        SPLIT_PATH = os.path.join(args.data_path, 'mini-imagenet/split')
