...
# copied from https://github.com/mrkshllr/FewTURE/blob/main/datasets/samplers.py
"""
#
#
import os
...
class CIFARFS_DatasetLoader(Dataset):

    def __init__(self, args, setname='test', train_augmentation=None):
